...
**Key Points:**
- Tokens expire after 24 hours (example); production code should clamp TTL to sane bounds
- Secret key loaded from environment only (no fallback); minimum length 32
