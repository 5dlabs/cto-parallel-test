...
/// New user data for inserting into the database
...
/// New product data for inserting into the database
#[derive(Insertable, Deserialize, Debug)]
#[diesel(table_name = products)]
...
/// New cart data for inserting into the database
...
/// New cart item data for inserting into the database
#[derive(Insertable, Debug)]
#[diesel(table_name = cart_items)]
