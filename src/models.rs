...
/// Represents data for inserting a new user.
...
/// Represents data for inserting a new product.
#[derive(Insertable, Deserialize, Debug)]
#[diesel(table_name = products)]
...
/// Represents data for inserting a new cart.
...
/// Represents data for inserting a new cart item.
#[derive(Insertable, Debug)]
#[diesel(table_name = cart_items)]
