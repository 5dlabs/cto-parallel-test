...
mod database_tests {
    ...
    fn test_schema_tables_exist() {
        ...
        assert!(table_names.contains(&"users".to_string()), "users table missing");
        assert!(table_names.contains(&"products".to_string()), "products table missing");
        assert!(table_names.contains(&"carts".to_string()), "carts table missing");
        assert!(table_names.contains(&"cart_items".to_string()), "cart_items table missing");
    }
}
