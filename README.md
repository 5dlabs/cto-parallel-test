...
2. **Configure the database:**
   ...
   ```bash
   # .env
   DATABASE_URL=postgres://your_username:your_password@localhost/ecommerce_db
   ```
   
   Replace `your_username`, `your_password`, and `ecommerce_db` with your actual PostgreSQL credentials.
